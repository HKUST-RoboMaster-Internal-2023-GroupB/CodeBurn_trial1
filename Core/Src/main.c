...
/* USER CODE END PFP */
long int status,hello;
char uartRxData[6] = {}; // Declare Rx buffer
char uartTxData[7] = {}; // Declare Tx buffer
...
{
char*ptr;
status = strtol (uartRxData,&ptr,10);
...
HAL_UARTEx_ReceiveToIdle_IT(&huart2, (uint8_t *)uartRxData, 6);
